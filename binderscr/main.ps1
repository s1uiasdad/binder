...
$files = Get-ChildItem -Path $directoryPath -File | Out-GridView -PassThru -Title "Chọn file để thêm vào binder.ps1"

# Xóa file binder.ps1 nếu tồn tại
if (Test-Path "binder.ps1") {
    Remove-Item "binder.ps1"
}

# Tạo lại file binder.ps1 và thêm nội dung cần thiết
